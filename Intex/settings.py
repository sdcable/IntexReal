...
SECRET_KEY = 'SomeInsecurewaytodoingthis'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ["https://intexreal-main.up.railway.app"]
...
for username in client:
    if user.username != username.username :
        LOGIN_REDIRECT_URL = "addClient"
    else :
        LOGIN_REDIRECT_URL = "myjournal"
'''
